...
class CCInitViewController: UIViewController,UITextFieldDelegate {
    ...
    lazy var cancelUrlTextField: LeftPaddedTextField = {
        ...
        textField.text = "https://login.ccavenue.com/jsp/merchant/hdfcLogin.jsp ".trimmingCharacters(in: .whitespacesAndNewlines) //"http://122.182.6.216/merchant/ccavResponseHandler.jsp" //https://secure.ccavenue.com/jsp/ccavResponseHandler.jsp  //http://122.182.6.216/ae/ccavResponseHandler_nonS.jsp
        textField.layer.borderWidth = 1
        textField.layer.borderColor = UIColor.lightGray.cgColor
        textField.keyboardType = .emailAddress
        textField.translatesAutoresizingMaskIntoConstraints = false
    ...
    lazy var redirectUrlTextField: LeftPaddedTextField = {
        ...
        textField.text = "https://login.ccavenue.com/jsp/merchant/hdfcLogin.jsp ".trimmingCharacters(in: .whitespacesAndNewlines) //"http://122.182.6.216/merchant/ccavResponseHandler.jsp".trimmingCharacters(in: .whitespacesAndNewlines) //https://secure.ccavenue.com/jsp/ccavResponseHandler.jsp   //http://122.182.6.216/ae/ccavResponseHandler_nonS.jsp
        textField.layer.borderWidth = 1
        textField.layer.borderColor = UIColor.lightGray.cgColor
        textField.keyboardType = .emailAddress
        textField.translatesAutoresizingMaskIntoConstraints = false
    ...
    let submitButton:DesignableButton = {
        ...
        let attributedTitle = NSMutableAttributedString(string: "Submit", attributes: convertToOptionalNSAttributedStringKeyDictionary([convertFromNSAttributedStringKey(NSAttributedString.Key.font): UIFont.systemFont(ofSize: 17, weight: UIFont.Weight.medium), convertFromNSAttributedStringKey(NSAttributedString.Key.foregroundColor): Color.orange]))
    ...
    let cancelButton:DesignableButton = {
        let button = DesignableButton()
        let attributedTitle = NSMutableAttributedString(string: "Cancel", attributes: convertToOptionalNSAttributedStringKeyDictionary([convertFromNSAttributedStringKey(NSAttributedString.Key.font): UIFont.systemFont(ofSize: 17, weight: UIFont.Weight.medium), convertFromNSAttributedStringKey(NSAttributedString.Key.foregroundColor): Color.orange]))
        button.setAttributedTitle(attributedTitle, for: .normal)
        button.setTitleColor(Color.orange, for: .normal)
        button.cornerRadius = 5
        button.borderWidth = 1
    ...
    @objc func submitButtonClick(){
        ...
        if accessCodeTextField.text?.trimmingCharacters(in: .whitespacesAndNewlines) == "" {
            ...
            let attributedStr = NSAttributedString(string: "Access code is required field",
                                                   attributes:convertToOptionalNSAttributedStringKeyDictionary([convertFromNSAttributedStringKey(NSAttributedString.Key.foregroundColor): UIColor.red]))
