...
//                    //Toast.makeText(getApplicationContext(), status, Toast.LENGTH_SHORT).show();
            ...
            try {
                String postData = AvenuesParams.ACCESS_CODE + "=" + URLEncoder.encode(mainIntent.getStringExtra(AvenuesParams.ACCESS_CODE), "UTF-8") + "&"
                        ...
                        + AvenuesParams.DELIVERY_EMAIL+ "=" + URLEncoder.encode(mainIntent.getStringExtra(AvenuesParams.DELIVERY_EMAIL), "UTF-8") + "&"
                        ...
                        + AvenuesParams.MERCHANT_PARAM3+ "=" + URLEncoder.encode(mainIntent.getStringExtra(AvenuesParams.MERCHANT_PARAM3), "UTF-8") + "&"
                        + AvenuesParams.MERCHANT_PARAM4 + "=" + URLEncoder.encode(mainIntent.getStringExtra(AvenuesParams.MERCHANT_PARAM4), "UTF-8") + "&"
                        + AvenuesParams.MERCHANT_PARAM5+ "=" + URLEncoder.encode(mainIntent.getStringExtra(AvenuesParams.MERCHANT_PARAM5), "UTF-8") + "&"
                        + AvenuesParams.CUSTOMER_IDENTIFIER+ "=" + URLEncoder.encode(mainIntent.getStringExtra(AvenuesParams.CUSTOMER_IDENTIFIER), "UTF-8") + "&"
